...
public:
    ...
    class BWDIterator; // Backward declaration
...
public:
    ...
    public:
        ...
        virtual void remove(void (*removeItemData)(T) = 0)
        {
...
DLinkedList<T>::DLinkedList(
    ...
    bool (*itemEqual)(T &, T &)) : deleteUserData(deleteUserData), itemEqual(itemEqual), count(0)
{
    // TODO:
    head = new Node();
    tail = new Node();
